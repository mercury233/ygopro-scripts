...
function c12021072.initial_effect(c)
	...
	e5:SetValue(1)
	c:RegisterEffect(e5)
	if YGO233_TAG and not c12021072.global_check then
		c12021072.global_check=true
		Debug.Message("活动中「大胆无敌」效果在双打模式改为「自己基本分是20000以上的场合」，节日快乐！")
	end
end
...
function c12021072.indcon(e)
	local cond=YGO233_TAG and 20000 or 10000
	return Duel.GetLP(e:GetHandlerPlayer())>=cond
end
