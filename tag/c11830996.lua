...
function c11830996.initial_effect(c)
	...
	c:RegisterEffect(e1)
	if YGO233_TAG and not c11830996.global_check then
		c11830996.global_check=true
		Debug.Message("活动中「古之叶」效果在双打模式改为「自己基本分是18000以上的场合」，节日快乐！")
	end
end
function c11830996.condition(e,tp,eg,ep,ev,re,r,rp)
	local cond=YGO233_TAG and 18000 or 9000
	return Duel.GetLP(tp)>=cond
end
