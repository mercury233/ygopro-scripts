...
function c36378044.initial_effect(c)
	...
	c:RegisterEffect(e3)
	if YGO233_TAG and not c36378044.global_check then
		c36378044.global_check=true
		Debug.Message("活动中「幸运拳」效果在双打模式改为「自己失去12000基本分」，节日快乐！")
	end
end
...
function c36378044.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local cond=YGO233_TAG and 12000 or 6000
	Duel.SetLP(tp,lp-cond)
end
