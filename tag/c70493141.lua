...
function c70493141.initial_effect(c)
	...
	c:RegisterEffect(e2)
	if YGO233_TAG and not c70493141.global_check then
		c70493141.global_check=true
		Debug.Message("活动中「雷仙神」效果在双打模式改为「支付6000基本分」，节日快乐！")
	end
end
